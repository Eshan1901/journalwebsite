  ...
  return (
    <div className="container">
      <div className="section">
        <h1 className="text-center" style={{ marginBottom: '10px' }}>Authors' Guidelines</h1>
        <p className="text-center lead" style={{ marginBottom: '30px' }}>
        ...
        <div style={{ 
          ...
          <h3 style={{ marginTop: 0 }}><i className="fas fa-compass"></i> Quick Navigation</h3>
          <div style={{ 
            display: 'grid', 
            ...
            {[
              ...
              { id: 'format', label: 'Article Format' },
              { id: 'figures', label: 'Figures & Tables' },
              { id: 'references', label: 'References' },
              { id: 'ethics', label: 'Ethics & Policy' },
            ].map(item => (
              <button
                key={item.id}
                onClick={() => scrollToSection(item.id)}
                style={{
                  background: activeSection === item.id ? '#2c5aa0' : 'white',
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          {/* Submission Process */}
          <div id="submission" className="card">
