        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <div className="card">
            ...
            <div style={{ 
              ...
              <ul style={{ marginBottom: '0', paddingLeft: '20px' }}>
                ...
                <li>Submit your final paper as PDF to submission.jcids@gnosispress.org</li>
          ...
          <div className="card">
            ...
            <ul>
              ...
              <li>All submissions must be sent directly to <strong>submission.jcids@gnosispress.org</strong></li>
